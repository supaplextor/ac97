...
|------|---------|-----------------|
| Visual Studio 2022 | 17.x or newer (Community edition is fine) | [visualstudio.microsoft.com](https://visualstudio.microsoft.com/) |
| Windows Driver Kit (WDK) | Matching your VS 2022 install | [learn.microsoft.com/windows-hardware/drivers/download-the-wdk](https://learn.microsoft.com/en-us/windows-hardware/drivers/download-the-wdk) |
| Windows SDK | Installed automatically with VS 2022 | Included in VS installer |
...
1. Download and run the **Visual Studio 2022** installer.
...
1. After VS 2022 finishes, download the **WDK for Windows 11** from the link in the Prerequisites table above.
2. Run the WDK installer. It will automatically install the **WDK VS extension** into Visual Studio 2022.
...
| Property path | Value |
|---------------|-------|
| **General → Platform Toolset** | `Windows Driver Kit (v143)` |
...
> `makecert` and `signtool` are shipped with the WDK/SDK and are available in a **Developer Command Prompt for VS 2022**.
